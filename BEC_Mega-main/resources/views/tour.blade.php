        ...
        <div id="ar-modal-box" style="position: relative;">
            ...
            <div id="ar-scanning-overlay">
                ...
                <div class="scanning-content">
                    ...
                    <div class="scanning-instruction" style="margin-top:10px; font-size:1rem; color:#fff; text-align:center;">Arahkan ponsel ke bawah untuk memulai AR</div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            rooms.forEach(room => {
                ...
                const limiter = Marzipano.RectilinearView.limit.traditional(8192, 110*Math.PI/180);
                ...
                if (dnPairs[room.id]) {
                    ...
                    const dayView = new Marzipano.RectilinearView({ yaw: 0, pitch: 0, fov: 90*Math.PI/180 }, limiter);
                    scenes[room.id + "-day"] = viewer.createScene({ source: daySource, geometry, view: dayView, pinFirstLevel: true });
                }
            });
