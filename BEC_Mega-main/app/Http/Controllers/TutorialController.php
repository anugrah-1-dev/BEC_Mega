...
class TutorialController extends Controller
{
    ...
    public function addComment(Request $request)
    {
        ...
        if (preg_match('/(cara|bagaimana|gimana|tutor|langkah|proses).*(daftar|registrasi|masuk|gabung)/i', $lower) || str_contains($lower, 'daftar') || str_contains($lower, 'registrasi')) {
            ...
            $reply = $prefix . "Kampus Brilliant English Course (BEC) berlokasi di Jl. Flamboyan No.127B, Mulyoasri, Tulungrejo, Kec. Pare, Kabupaten Kediri, Jawa Timur 64212. Lokasinya sangat asri dan strategis, pas banget buat fokus belajar berbagai kursus bahasa!";
        ...
        } else if (preg_match('/(kanan|kiri|geser|putar|keliling)/i', $lower) || str_contains($lower, 'kanan kiri')) {
            $reply = $prefix . "Caranya klik saja menggunakan tombol hotspot yang tersedia di web ya, atau bisa juga dengan men-drag layar untuk melihat sekeliling.";
